...
const Home = () => {
  return (
    <>
      ...
      <div className='bg-indigo-800 w-full py-16 px-5 md:h-screen md:py-24'>
        <div className='flex flex-wrap justify-center items-center'>
          <div className='grid grid-cols-1 md:grid-cols-2  gap-8' >
            <div className='flex flex-col '>
              <h1 className='text-white font-bold text-3xl'>Single Stop Solution For School Management</h1>
            ...
            <div className='flex flex-col'>
            <img src="https://eskooly.com/assets/images/illustrations/mockups/landing3/online-class.png" alt="Hero" className="mb-5 w-full h-auto object-cover md:max-h-full floating" />
            </div>
          </div>
